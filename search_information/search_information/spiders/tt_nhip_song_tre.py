...
class TtNhipSongTreSpider(scrapy.Spider):
    name = 'tt_nhip_song_tre'
    allowed_domains = ['tuoitre.vn/nhip-song-tre']
    start_urls = []

    def start_requests(self):
        for i in range(1, 201):
            page = 'http://tuoitre.vn/nhip-song-tre/trang-'+str(i)+'.htm'
